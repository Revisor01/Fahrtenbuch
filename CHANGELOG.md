...
- Beim Einreichen mehrerer Monate auf einmal lud die App nach jedem einzelnen Monat die gesamte Fahrtenliste neu. Bei zwölf Monaten waren das zwei Dutzend überflüssige Abfragen, die in ungünstigen Fällen an die Anfragegrenze stießen. Jetzt wird einmal am Ende aktualisiert
- Der Start der App und jedes Speichern brauchen deutlich weniger Abfragen: 8 statt 35. Die Monatsübersicht kommt jetzt in einer Abfrage statt in 28 einzelnen. In der Monatsauswahl erscheinen dadurch auch Jahrgänge, die älter als zwei Jahre sind — bisher fehlten sie dort, obwohl die Fahrten vorhanden waren
...
- In der Android-App war der Knopf „Aktueller Standort" beim Erfassen wirkungslos — die nötige Berechtigung fehlte, und Android lehnte die Anfrage ohne Rückfrage ab. Auf dem iPhone hatte er immer funktioniert
- Die Android-App wurde nicht mehr ins Google-Konto gesichert. Dabei konnte die gespeicherte Anmeldung mitwandern; verloren geht nichts, weil alle Daten auf dem Server liegen
- Die Datenschutzerklärung beschrieb die App falsch: Sie nannte ein Analysewerkzeug und Cookies, die es nicht gibt, und verschwieg den Dienst für die Adresssuche. Jetzt steht dort, was tatsächlich passiert — einschließlich dessen, dass beim Antippen der Standortbestimmung Koordinaten an diesen Dienst gehen
- Wer kurz nach dem Speichern den Kirchenkreis wechselte, konnte danach unter der neuen Anmeldung noch Daten des vorherigen sehen: verspätete Antworten überschrieben die neuen. Antworten aus einer beendeten Sitzung werden jetzt verworfen
...
- Die App zeigt auf iPhone und Android eine Navigationsleiste des Geräts statt einer nachgebauten im Browserfenster — auf dem iPhone die schwebende Glasleiste mit gefülltem Symbol, auf Android die gewohnte Leiste mit farbig hinterlegtem aktivem Eintrag. Auf dem iPhone ist es ab iOS 26 die Leiste des Systems selbst; auf älteren iPhones und auf Android ist sie dem System nachempfunden und vom Gerät gezeichnet. Dazu gehören Bewegung, die Anzeige der Zahl offener Abrechnungen und Bedienhilfen. Ihre Farben folgen weiterhin dem Fahrtenbuch und wechseln mit hellem und dunklem Design. Im Browser bleibt alles wie bisher
