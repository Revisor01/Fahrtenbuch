...
Plans:
- [x] 27-01-PLAN.md — Backend: getReportRange pro-Monat-Status statt Aggregation
- [x] 27-02-PLAN.md — Frontend: Status-Badge-Warning, card-container-highlight Cleanup
